...
void show_message(void){
	...
	while(front<&message[67]){ // front will wait back to reach all the list members
		if(aux > MATRIXSIZE){ // when finished to show message shows again with offset of 1 position
